...
export namespace Protocol {
  ...
  export class IssuingAttributes extends jspb.Message {
    ...
    setAttributesList(
      value: Array<Protocol.IssuingAttributes.Attribute>
    ): IssuingAttributes;
    addAttributes(
      value?: Protocol.IssuingAttributes.Attribute,
      index?: number
    ): Protocol.IssuingAttributes.Attribute;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): IssuingAttributes.AsObject;
    static toObject(
      includeInstance: boolean,
      msg: IssuingAttributes
    ): IssuingAttributes.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class IssueCredentialMsg extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: IssueCredentialMsg
    ): IssueCredentialMsg.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class Proof extends jspb.Message {
    ...
    addAttributes(
      value?: Protocol.Proof.Attribute,
      index?: number
    ): Protocol.Proof.Attribute;
  ...
  export class Predicates extends jspb.Message {
    ...
    addPredicates(
      value?: Protocol.Predicates.Predicate,
      index?: number
    ): Protocol.Predicates.Predicate;
...
export class ProtocolStatus extends jspb.Message {
  ...
  setIssueCredential(
    value?: ProtocolStatus.IssueCredentialStatus
  ): ProtocolStatus;
...
export namespace ProtocolStatus {
  ...
  export class DIDExchangeStatus extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: DIDExchangeStatus
    ): DIDExchangeStatus.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class IssueCredentialStatus extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: IssueCredentialStatus
    ): IssueCredentialStatus.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class PresentProofStatus extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: PresentProofStatus
    ): PresentProofStatus.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class BasicMessageStatus extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: BasicMessageStatus
    ): BasicMessageStatus.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
