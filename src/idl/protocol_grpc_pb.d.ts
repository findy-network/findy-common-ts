...
interface IProtocolServiceService
...
interface IProtocolServiceService_IRun
  extends grpc.MethodDefinition<
    protocol_pb.Protocol,
    protocol_pb.ProtocolState
  > {
...
interface IProtocolServiceService_IStart
  extends grpc.MethodDefinition<protocol_pb.Protocol, protocol_pb.ProtocolID> {
...
interface IProtocolServiceService_IStatus
  extends grpc.MethodDefinition<
    protocol_pb.ProtocolID,
    protocol_pb.ProtocolStatus
  > {
...
interface IProtocolServiceService_IResume
  extends grpc.MethodDefinition<
    protocol_pb.ProtocolState,
    protocol_pb.ProtocolID
  > {
...
interface IProtocolServiceService_IRelease
  extends grpc.MethodDefinition<
    protocol_pb.ProtocolID,
    protocol_pb.ProtocolID
  > {
...
export interface IProtocolServiceServer
  ...
  run: grpc.handleServerStreamingCall<
    protocol_pb.Protocol,
    protocol_pb.ProtocolState
  >;
...
export interface IProtocolServiceClient {
  run(
    request: protocol_pb.Protocol,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<protocol_pb.ProtocolState>;
  run(
    request: protocol_pb.Protocol,
  ...
  start(
    ...
    callback: (
      ...
      response: protocol_pb.ProtocolID
    ) => void
  ...
  status(
    request: protocol_pb.ProtocolID,
    callback: (
      error: grpc.ServiceError | null,
      response: protocol_pb.ProtocolStatus
    ) => void
  ): grpc.ClientUnaryCall;
  status(
    request: protocol_pb.ProtocolID,
  ...
  resume(
    request: protocol_pb.ProtocolState,
    callback: (
      error: grpc.ServiceError | null,
      response: protocol_pb.ProtocolID
    ) => void
...
export class ProtocolServiceClient
  extends grpc.Client
  implements IProtocolServiceClient
{
  constructor(
    address: string,
