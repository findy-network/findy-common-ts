...
interface IAgentServiceService_IWait extends grpc.MethodDefinition<agent_pb.ClientID, agent_pb.Question> {
...
interface IAgentServiceService_IGive extends grpc.MethodDefinition<agent_pb.Answer, agent_pb.ClientID> {
...
interface IAgentServiceService_ICreateInvitation extends grpc.MethodDefinition<agent_pb.InvitationBase, agent_pb.Invitation> {
...
interface IAgentServiceService_ICreateSchema extends grpc.MethodDefinition<agent_pb.SchemaCreate, agent_pb.Schema> {
...
interface IAgentServiceService_ICreateCredDef extends grpc.MethodDefinition<agent_pb.CredDefCreate, agent_pb.CredDef> {
...
interface IAgentServiceService_IGetSchema extends grpc.MethodDefinition<agent_pb.Schema, agent_pb.SchemaData> {
...
interface IAgentServiceService_IGetCredDef extends grpc.MethodDefinition<agent_pb.CredDef, agent_pb.CredDefData> {
...
export interface IAgentServiceClient {
    listen(request: agent_pb.ClientID, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<agent_pb.AgentStatus>;
    listen(request: agent_pb.ClientID, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<agent_pb.AgentStatus>;
    wait(request: agent_pb.ClientID, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<agent_pb.Question>;
    wait(request: agent_pb.ClientID, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<agent_pb.Question>;
    give(request: agent_pb.Answer, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    give(request: agent_pb.Answer, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    give(request: agent_pb.Answer, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    ...
    createSchema(request: agent_pb.SchemaCreate, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    createSchema(request: agent_pb.SchemaCreate, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    createSchema(request: agent_pb.SchemaCreate, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    createCredDef(request: agent_pb.CredDefCreate, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    createCredDef(request: agent_pb.CredDefCreate, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    createCredDef(request: agent_pb.CredDefCreate, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    getSchema(request: agent_pb.Schema, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
    getSchema(request: agent_pb.Schema, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
    getSchema(request: agent_pb.Schema, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
...
export class AgentServiceClient extends grpc.Client implements IAgentServiceClient {
    ...
    public wait(request: agent_pb.ClientID, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<agent_pb.Question>;
    public give(request: agent_pb.Answer, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    public give(request: agent_pb.Answer, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    public give(request: agent_pb.Answer, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.ClientID) => void): grpc.ClientUnaryCall;
    ...
    public createSchema(request: agent_pb.SchemaCreate, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    public createSchema(request: agent_pb.SchemaCreate, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    public createSchema(request: agent_pb.SchemaCreate, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.Schema) => void): grpc.ClientUnaryCall;
    public createCredDef(request: agent_pb.CredDefCreate, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    public createCredDef(request: agent_pb.CredDefCreate, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    public createCredDef(request: agent_pb.CredDefCreate, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.CredDef) => void): grpc.ClientUnaryCall;
    public getSchema(request: agent_pb.Schema, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
    public getSchema(request: agent_pb.Schema, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
    public getSchema(request: agent_pb.Schema, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: agent_pb.SchemaData) => void): grpc.ClientUnaryCall;
