...
export namespace Question {
  ...
  export class ProofVerifyMsg extends jspb.Message {
    ...
    setAttributesList(
      value: Array<Question.ProofVerifyMsg.Attribute>
    ): ProofVerifyMsg;
    addAttributes(
      value?: Question.ProofVerifyMsg.Attribute,
      index?: number
    ): Question.ProofVerifyMsg.Attribute;
